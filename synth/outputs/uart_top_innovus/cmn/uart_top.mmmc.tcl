#################################################################################
#
# Created by Genus(TM) Synthesis Solution 23.10-p004_1 on Mon May 11 22:27:16 +07 2026
#
#################################################################################

## library_sets
create_library_set -name ls_of_ld_slow \
    -timing { /home/ngominhduc/Documents/VKU_Project/UART_Design/sky130_scl_9T_0.1.2/sky130_scl_9T/lib/sky130_ss_1.62_125_nldm_dontFalse.lib }
create_library_set -name ls_of_ld_fast \
    -timing { /home/ngominhduc/Documents/VKU_Project/UART_Design/sky130_scl_9T_0.1.2/sky130_scl_9T/lib/sky130_ff_1.98_0_nldm_dontFalse.lib }
create_library_set -name ls_of_ld_typ \
    -timing { /home/ngominhduc/Documents/VKU_Project/UART_Design/sky130_scl_9T_0.1.2/sky130_scl_9T/lib/sky130_tt_1.8_25_nldm_dontFalse.lib }
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { ./outputs/uart_top_innovus/cmn/uart_top.mmmc/modes/default_emulate_constraint_mode/default_emulate_constraint_mode.sdc.gz }
